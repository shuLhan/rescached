...
----
$ go install kilabit.info/rescached/cmd/rescached
----
...
image:https://git.kilabit.info/rescached/plain/_www/doc/images/Screenshot_wui_frontpage.png[Screenshot
...
image:https://git.kilabit.info/rescached/plain/_www/doc/images/Screenshot_wui_environment.png[rescached environment page,320]

The Environment page allow user to modify the rescached configuration on the
fly.

.Screenshot of Hosts Blocks page
image:https://git.kilabit.info/rescached/plain/_www/doc/images/Screenshot_wui_hosts_blocks.png[rescached
...
image:https://git.kilabit.info/rescached/plain/_www/doc/images/Screenshot_wui_hosts_d.png[rescached
Hosts.d page,320]
...
image:https://git.kilabit.info/rescached/plain/_www/doc/images/Screenshot_wui_zone_d.png[rescached
Zone.d page,320]
...
https://git.kilabit.info/rescached/[Repository^]::
