...
link:README.html[rescached MANUAL^]:: Manual page for rescached program.

link:rescached.cfg.html[rescached.cfg^]:: Manual page for rescached
configuration.

link:resolver.html[resolver MANUAL^]:: Manual page for resolver.
...
Feel free to send a patch or report a bug by sending email to
<ms@kilabit.info>.
